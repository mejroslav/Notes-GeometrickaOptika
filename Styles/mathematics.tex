...
\newcommand{\der}[2]{\dfrac{\mathrm{d}#1}{\mathrm{d}#2}} % obyčejná derivace
\newcommand{\pder}[2]{\dfrac{\partial #1}{\partial #2}} % parciální derivace
...
\newcommand{\inRn}{\int_{\R^n}} % integrál v R^n
\newcommand{\grad}{\vc \nabla} % gradient vektorově
%----------------------------------------------------
